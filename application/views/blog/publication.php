...
<div role="main" class="main">
    ...
    <section class="page-header">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1>Contenido de la publicación</h1>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <article class="post post-large blog-single-post">
                        <div class="post-image">
                            <div class="owl-carousel owl-theme owl-loaded owl-drag owl-carousel-init" data-plugin-options="{'items':1}">
                                <img class="img-responsive img-thumbnail" src="<?php echo base_url('assets/img/blog/blog-image-1.jpg') ?>" alt="">
                                <img class="img-responsive img-thumbnail" src="<?php echo base_url('assets/img/blog/blog-image-1.jpg') ?>" alt="">
                            </div>
                        </div>
                        <div class="post-date">
                        ...
                        <div class="post-content">
                            ...
                            <div class="post-block post-share">
                                ...
                                <div class="addthis_toolbox addthis_default_style ">
                                    <a class="addthis_counter addthis_pill_style addthis_nonzero" href="#" style="display: inline-block;"></a>
                            ...
                            <div class="post-block post-author clearfix">
                                ...
                                <div class="img-thumbnail">
                                    ...
                                    <img src="<?php echo base_url('assets/img/avatars/avatar.jpg') ?>" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="post-block post-comments clearfix">
                                ...
                                <ul class="comments">
                                    <li>
                                        <div class="comment">
                                            <div class="img-thumbnail">
                                                <img class="avatar" alt="" src="<?php echo base_url('assets/img/avatars/avatar-2.jpg') ?>">
                                            </div>
                                        ...
                                        <ul class="comments reply">
                                            <li>
                                                <div class="comment">
                                                    <div class="img-thumbnail">
                                                        <img class="avatar" alt="" src="<?php echo base_url('assets/img/avatars/avatar-3.jpg') ?>">
                                                    </div>
                                                    <div class="comment-block">
                                                        <div class="comment-arrow"></div>
                                                        <span class="comment-by">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="img-thumbnail">
                                                        <img class="avatar" alt="" src="<?php echo base_url('assets/img/avatars/avatar-4.jpg') ?>">
                                                    </div>
                                                    <div class="comment-block">
                                                        <div class="comment-arrow"></div>
                                                        <span class="comment-by">
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="img-thumbnail">
                                                <img class="avatar" alt="" src="<?php echo base_url('assets/img/avatars/avatar.jpg') ?>">
                                            </div>
                                            <div class="comment-block">
                                                <div class="comment-arrow"></div>
                                                <span class="comment-by">
                            ...
                            <div class="post-block post-leave-comment">
                                <h3 class="heading-primary">Deja un comentario</h3>
                                <form action="" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="submit" value="Publicar comentario" class="btn btn-primary btn-lg" data-loading-text="Loading...">
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <ul class="simple-post-list">
                                    <li>
                                        <div class="post-image">
                                            <div class="img-thumbnail">
                                                <a href="blog-post.html">
                                                <img src="<?php echo base_url('assets/img/blog/blog-thumb-1.jpg') ?>" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                    ...
                                    <li>
                                        <div class="post-image">
                                            <div class="img-thumbnail">
                                                <a href="blog-post.html">
                                                <img src="<?php echo base_url('assets/img/blog/blog-thumb-2.jpg') ?>" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                    ...
                                    <li>
                                        <div class="post-image">
                                            <div class="img-thumbnail">
                                                <a href="blog-post.html">
                                                <img src="<?php echo base_url('assets/img/blog/blog-thumb-3.jpg') ?>" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="post-info">
